...
<form method="post" class="form-horizontal">
	...
	<div class="content">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="from_name" id="from_name" value="<?php echo $file->user_name; ?>">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="from_email" id="from_email" value="<?php echo $file->user_email; ?>">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="to_email" id="to_email" value="<?php echo $file->client_email; ?>">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="subject" id="subject" value="<?php echo lang('quote'); ?> #<?php echo $file->quote_number; ?>">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo auto_link(site_url('guest/view/quote/' . $file->quote_url_key)); ?>
            </div>
        </div>
